          ...
          <div class="row text-center m-t-25">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="row m-b-25 m-t-25">
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="service-item">
                    <button data-toggle="modal" href="#benih" class="btn btn-simforta-icon waves-circle bgm-amber"><i class="simforta-lg md-grain"></i></button>
                    <h4> <strong>BENIH &amp; PUPUK</strong> </h4>
                    <p>&nbsp;</p>
                  </div>
                </div>
                <div class="col-md-3 col-sm-6">
                  <div class="service-item">
                    <button data-toggle="modal" href="#budidaya" class="btn btn-simforta-icon waves-circle bgm-pink"><i class="simforta-lg md-nature-people"></i></button>
                    <h4> <strong>BUDIDAYA</strong> </h4>
                    <p>&nbsp;</p>
                  </div>
                </div>
                <div class="col-md-3 col-sm-6">
                  <div class="service-item">
                    <button data-toggle="modal" href="#harga" class="btn btn-simforta-icon waves-circle bgm-red"><i class="simforta-lg md-local-shipping"></i></button>
